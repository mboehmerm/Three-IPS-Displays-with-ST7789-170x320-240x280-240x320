...
#define _TFT_eSPI_ESP32H_
  ...
  #warning >>>>------>> DMA is not supported on the ESP32 C2,C3,C6,H2,C61,C5,P4 + S31 (possible future update)
#endif
...
//?// ESP32 C6,H2,C2,C5,C61,P4,S31

#if !defined(CONFIG_IDF_TARGET_ESP32H2) && !defined(CONFIG_IDF_TARGET_ESP32C6) && !defined(CONFIG_IDF_TARGET_ESP32C2)&& !defined(CONFIG_IDF_TARGET_ESP32C5) && !defined(CONFIG_IDF_TARGET_ESP32P4) && !defined(CONFIG_IDF_TARGET_ESP32C61) && !defined(CONFIG_IDF_TARGET_ESP32S31) && !defined(CONFIG_IDF_TARGET_ESP32C3) && !defined(CONFIG_IDF_TARGET_ESP32S2) && !defined(CONFIG_IDF_TARGET_ESP32) 
  #define CONFIG_IDF_TARGET_ESP32
#endif
...
//?// ESP32 C3,C6
  ...
  */
  ...
  //#if CONFIG_IDF_TARGET_ESP32C6         //?// Speedlimit ESP32-C6 and ESP32-C6 40MHz why ?
  //  #undef APB_CLK_FREQ
...
//?// ESP32 H2
#if defined(CONFIG_IDF_TARGET_ESP32H2)  //?// ESP32 H2
...
ESP32 C3, C6, H2 : Only 1 SPI port available	//?// ESP32-C6 + ESP32-H2 ( C2,C5,C61,S31,P4 ??? )
FSPI = 1, uses SPI2
HSPI = 1, uses SPI2
VSPI not defined so have made VSPI = HSPI
...
// ESP32 specific SPI port selection - only SPI2_HOST available on C3    //?// ESP32 c2,C3,C6,C5,C61,P4,S31
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    #if defined(CONFIG_IDF_TARGET_ESP32C3) || defined(CONFIG_IDF_TARGET_ESP32C6) || defined(CONFIG_IDF_TARGET_ESP32H2) || defined(CONFIG_IDF_TARGET_ESP32S2) || defined(CONFIG_IDF_TARGET_ESP32C2) ||defined(CONFIG_IDF_TARGET_ESP32C5) || defined(CONFIG_IDF_TARGET_ESP32P4) || defined(CONFIG_IDF_TARGET_ESP32C61) || defined(CONFIG_IDF_TARGET_ESP32S31)
      #if (TFT_MISO == -1)
        #undef TFT_MISO
...
//* Replacement slimmer macros
  //?// ESP32 C2,C3,C6,C5,C61,P4,S31
  //#if !defined(CONFIG_IDF_TARGET_ESP32C3)
  #if !defined(CONFIG_IDF_TARGET_ESP32C3) && !defined(CONFIG_IDF_TARGET_ESP32C6) && !defined(CONFIG_IDF_TARGET_ESP32H2)	&& !defined(CONFIG_IDF_TARGET_ESP32C2)&& !defined(CONFIG_IDF_TARGET_ESP32C5) && !defined(CONFIG_IDF_TARGET_ESP32P4) && !defined(CONFIG_IDF_TARGET_ESP32C61) && !defined(CONFIG_IDF_TARGET_ESP32S31)
