...
The "E" in the manufacturing code "FEF0" stands for [Chip Revision v1.3](https://docs.espressif.com/projects/esp-chip-errata/en/latest/esp32p4/01-chip-identification/index.html). "NRW32" = 32MB in-package PSRAM. 25VQ128ASIG = 16MB Flash.
...
**Power consumption** of the WT9932P4-TINY is about 37mA at 5V, when running the NV3007 display ( Backlight 22mA ).
