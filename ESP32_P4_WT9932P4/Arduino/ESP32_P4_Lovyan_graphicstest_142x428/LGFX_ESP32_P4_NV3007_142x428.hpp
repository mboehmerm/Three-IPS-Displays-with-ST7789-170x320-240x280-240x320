...
public:
  ...
  LGFX(void)
  {
    { // Configure bus control settings.
      ...
      // SPI bus settings
      cfg.spi_host  = SPI2_HOST;       // Select SPI to use ESP32-S2,C3,Cx,P4 : SPI2_HOST or SPI3_HOST / ESP32 : VSPI_HOST or HSPI_HOST
      //cfg.spi_host    = SPI3_HOST;       // Select SPI to use ESP32-S2,C3,Cx,P4 : SPI2_HOST or SPI3_HOST / ESP32 : VSPI_HOST or HSPI_HOST
...
//
    ...
    { // Set display panel controls.
      ...
      cfg.panel_width      =   142;  // actual visible width
      cfg.panel_height     =   428;  // actual visible height
      cfg.offset_x         =    12;  // Panel offset amount in X direction
      ...
      //cfg.memory_width     =   428;  // Maximum width supported by the driver IC
      //cfg.memory_height    =   168;  // Maximum height supported by the driver IC
