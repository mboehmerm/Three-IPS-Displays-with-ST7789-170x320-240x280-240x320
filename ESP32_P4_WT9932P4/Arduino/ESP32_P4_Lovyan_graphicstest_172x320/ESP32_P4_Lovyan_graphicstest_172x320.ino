...
//  Use LovyanGFX :
//    uncomment the line ( //#define Lovyan -> #define Lovyan )

//  Use TFT_eSPI
//    comment the line   ( #define Lovyan -> //#define Lovyan )
//    Enable in !\libraries\TFT_eSPI\User_Setup_Select.h" the line
//      #include <../Setup484_P4_ST7789_320x172.h>      // ESP32-P4 WT9932P4, ST7789, 80MHz

#define Lovyan  // uncomment this line to use LovyanGFX library
#ifdef Lovyan
	#include <LGFX_ESP32_P4_ST7789_172x320.hpp>
...
void setup() {
  ...
  Serial.println(""); Serial.println("");
 	...
 	#ifdef Lovyan
    Serial.println(F("Lovyan's TFT_eSPI library Test with ST7789"));  
  #else
    Serial.println(F("Bodmer's TFT_eSPI library Test with ST7789"));  
  #endif
...
uint32_t testHaD()
{
  ...
  for (int i = 0; i < 0x10; i++)
  {
    ...
    tft.setAddrWindow(21, 80, 128, 160);  // for Display 172x320
    //tft.setAddrWindow(10, 80, 128, 160);    // for Display 142x428
    //tft.setAddrWindow(0, 70, 128, 160);   // for Display 76x284
...
Library                  Bodmer    Lovyan
Benchmark                  Time      Time (microseconds)
HaD pushColor             78932     79242
Screen fill               11716     11553
Text                      16811      9576
Pixels                   224576    199345
Lines                    246145    219416
Horiz/Vert Lines           6472      5733  
Rectangles (outline)       3192      2811
Rectangles (filled)       63756     62786 
Circles (filled)          30865     23349
Circles (outline)         23250     20220
Triangles (outline)       10020      8660
Triangles (filled)        29523     26238
Rounded rects (outline)    9273      6171
Rounded rects (filled)    67356     64711
Done!


Lovyan's TFT_eSPI library Test with ST7789
...
Pixels                   199345
Lines                    219416
Horiz/Vert Lines         5733
Rectangles (outline)     2811
Rectangles (filled)      62786
Circles (filled)         23349
Circles (outline)        20220
Triangles (outline)      8660
Triangles (filled)       26238
Rounded rects (outline)  6171
Rounded rects (filled)   64711
Done!


Bodmer's TFT_eSPI library Test with ST7789
Benchmark                Time (microseconds)
HaD pushColor            78932
Screen fill              11716
Text                     16811
Pixels                   224576
Lines                    246145
Horiz/Vert Lines         6472
Rectangles (outline)     3192
Rectangles (filled)      63756
Circles (filled)         30865
Circles (outline)        23250
Triangles (outline)      10020
Triangles (filled)       29523
Rounded rects (outline)  9273
Rounded rects (filled)   67356
Done!
