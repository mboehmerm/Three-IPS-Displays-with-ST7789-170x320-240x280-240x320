...
void setup() {
  ...
  //https://github.com/Bodmer/TFT_eSPI/issues/3751
  //SPI.begin(TFT_SCLK, TFT_MISO, TFT_MOSI, TFT_CS); // Add this line 
  tft.init();
...
uint32_t testHaD()
{
  ...
  for (int i = 0; i < 0x10; i++)
  {
    ...
    tft.setAddrWindow(10, 80, 128, 160);    // for Display 172x320
...
Benchmark                  Time      Time      Time (microseconds)
...
Pixels                   248119
Lines                    276226
Horiz/Vert Lines         7261
Rectangles (outline)     2327
Rectangles (filled)      36393
Circles (filled)         32109
Circles (outline)        25139
Triangles (outline)      6846
Triangles (filled)       17937
Rounded rects (outline)  6696
...
Bodmer's TFT_eSPI library Test!
Benchmark                Time (microseconds)
HaD pushColor            146629
Screen fill              25334
Text                     22255
Pixels                   328804
Lines                    377715
Horiz/Vert Lines         12525
Rectangles (outline)     3870
Rectangles (filled)      70934
Circles (filled)         47858
Circles (outline)        33579
Triangles (outline)      9293
Triangles (filled)       30399
Rounded rects (outline)  9315
Rounded rects (filled)   73996
Done!
...
Benchmark                Time (microseconds)
HaD pushColor            127591
Screen fill              21632
Text                     21641
Pixels                   344776
Lines                    383880
Horiz/Vert Lines         10385
Rectangles (outline)     3343
Rectangles (filled)      60506
Circles (filled)         44954
Circles (outline)        33428
Triangles (outline)      9216
Triangles (filled)       27515
Rounded rects (outline)  8698
Rounded rects (filled)   63773
Done!
*/
