...
//?// ESP32-C6 + ESP32-H2
#if !defined(CONFIG_IDF_TARGET_ESP32H2) && !defined(CONFIG_IDF_TARGET_ESP32C6) && !defined(CONFIG_IDF_TARGET_ESP32C3) && !defined(CONFIG_IDF_TARGET_ESP32S2) && !defined(CONFIG_IDF_TARGET_ESP32)
  #define CONFIG_IDF_TARGET_ESP32
#endif
...
#if CONFIG_IDF_TARGET_ESP32C3 || CONFIG_IDF_TARGET_ESP32C6	//?// ESP32-C6
  /*
...
ESP32 C3, C6, H2 : Only 1 SPI port available	//?// ESP32-C6 + ESP32-H2
FSPI = 1, uses SPI2
HSPI = 1, uses SPI2
VSPI not defined so have made VSPI = HSPI
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    #if defined(CONFIG_IDF_TARGET_ESP32C3) || defined(CONFIG_IDF_TARGET_ESP32C6) || defined(CONFIG_IDF_TARGET_ESP32H2) || defined(CONFIG_IDF_TARGET_ESP32S2)	//?// ESP32-C6 + ESP32-H2
      #if (TFT_MISO == -1)
        #undef TFT_MISO
...
//* Replacement slimmer macros
  ...
  #if !defined(CONFIG_IDF_TARGET_ESP32C3) && !defined(CONFIG_IDF_TARGET_ESP32C6) && !defined(CONFIG_IDF_TARGET_ESP32H2)	//?// ESP32-C6 + ESP32-H2
