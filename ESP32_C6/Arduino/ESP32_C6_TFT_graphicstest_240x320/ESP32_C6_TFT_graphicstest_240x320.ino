...
void setup() {
  ...
  while (!Serial);
  Serial.println(""); 
  Serial.println("Bodmer's TFT_eSPI library Test! espressif 3.0.x"); 
...
HaD pushColor            152666
Screen fill              32674
Text                     26210
Pixels                   509375
Lines                    554582
Horiz/Vert Lines         15331
Rectangles (outline)     10114
Rectangles (filled)      339679
Circles (filled)         70517
Circles (outline)        51393
Triangles (outline)      32506
Triangles (filled)       134303
Rounded rects (outline)  26392
Rounded rects (filled)   349434
Done!
