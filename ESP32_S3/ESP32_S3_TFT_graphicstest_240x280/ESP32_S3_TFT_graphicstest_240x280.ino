...
void setup() {
  ...
  Serial.print("VSPI : ");  // 0 = FSPI
  Serial.println(VSPI); 

  Serial.print("SPI_PORT : ");   // 0  !!!   ( must be 2 ! // 1 bei 2.0.14 )
...
Pixels                   252085
Lines                    274074
Horiz/Vert Lines         7542
Rectangles (outline)     5476
Rectangles (filled)      173901
Circles (filled)         34310
Circles (outline)        26255
Triangles (outline)      18582
Triangles (filled)       70377
Rounded rects (outline)  15277
Rounded rects (filled)   179578
Done!
...
Pixels                   251279
Lines                    273843
Horiz/Vert Lines         7539
Rectangles (outline)     5467
Rectangles (filled)      173921
Circles (filled)         34309
Circles (outline)        26250
Triangles (outline)      18576
Triangles (filled)       70323
Rounded rects (outline)  15300
Rounded rects (filled)   179601
Done!
